...
Recorded by CI on the first successful build/release under the documented
`SOURCE`-mode build; see `.github/workflows/release.yml`'s `metrics.json`
artifact. No release has published these numbers yet.
